      ...
      ? [
          ...
          ...(isGlossaryContext
            ? [
                ...
                '    filterMapping.detectorTypes   → string[] from: SECRETS, PII, TOXIC, YARA, BROKEN_LINKS, LANGUAGE, CODE_SECURITY, CUSTOM',
                ...
                '  "Content safety concerns" → detectorTypes: ["TOXIC", "CUSTOM"]',
                '',
