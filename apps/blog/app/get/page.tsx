        ...
        aside={
          <div className="flex flex-col items-start gap-3">
            ...
            <span className="font-mono text-[11px] uppercase tracking-[0.12em] text-white/55">
              v{softwareVersion} · free · no signup
            </span>
          </div>
        }
      />
        ...
        <SectionShell tone="plain">
          <div className="space-y-8">
            ...
            <div className="mx-auto w-full max-w-3xl">
              <DockerRunBlock label="Run it" />
              <p className="mt-3 text-sm leading-6 text-muted-foreground">
                Then open{" "}
                <span className="font-mono text-foreground">
                  localhost:3000
                </span>
                . Needs Docker and 4 GB of memory. Those volumes are what keep
                your work across an upgrade — the{" "}
                <DocsLink href={docs.docker}>Docker guide</DocsLink> covers the
                environment variables, external databases and object storage.
              </p>
            </div>
