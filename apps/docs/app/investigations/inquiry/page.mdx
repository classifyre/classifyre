...
An inquiry can drive one or more [cases](/investigations/cases/). When it's
linked to a case:
...
## Inquiries vs duplicate review

Inquiries and [duplicate review](/duplicates/) are two
complementary ways to make sense of findings:

- An **inquiry** groups findings by **rule** — *"show me everything matching
  these criteria."*
- **Duplicate review** groups assets by **shared identity** — *"show me everything
  that looks like the same entity."*

Both feed [cases](/investigations/cases/), and both can be maintained for
you automatically by [Autopilot](/investigations/autopilot/) — which keeps
