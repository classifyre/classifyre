...
- **[Inquiries](/investigations/inquiry/)** watch findings by *rule*;
  fingerprints connect them by *shared identity*. They're complementary lenses on
  the same findings.
- **[Cases](/investigations/cases/)** are where a cluster becomes a real
  investigation, with evidence and hypotheses.
- **[Autopilot](/investigations/autopilot/)** keeps fingerprints up to date
