...
- **Add notes**, connect related items on the case board, and **update status**
...
> configured. See [Steering & Fine-Tuning](/investigations/autopilot/steering/).
...
**[How a Cycle Runs](/investigations/autopilot/cycle/)**.
