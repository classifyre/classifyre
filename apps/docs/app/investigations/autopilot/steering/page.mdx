...
Everything here lives in **Harness AI**. Provider assignment and external MCP
access are under **Configuration**; per-agent controls are under **Agents**.
...
See [Memory & System Brief](/investigations/autopilot/memory/) for how
...
Harness agents need a provider assigned specifically to the **Harness** role.
An Assistant assignment is independent and does not enable autonomous runs.
If an enabled agent is not doing anything, the **Setup** section of the System
Brief will usually flag a missing Harness provider as the reason.

Configure and test it under **Harness AI → Configuration**. See
[AI Providers](/settings/ai-providers/) for the complete setup and capability
testing guide.
...
**[Flight Recorder & Audit](/investigations/autopilot/flight-recorder/)**.
