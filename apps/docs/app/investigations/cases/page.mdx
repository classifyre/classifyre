...
A case is a structured **investigation case file**. It collects **evidence**
...
|---|---|
| **[Graph](/investigations/cases/graph/)** | Explore how assets and findings connect, visually |
| **Evidence** | Review the snapshotted assets and their findings; add notes; attach or detach items |
| **[Threads](/investigations/cases/hypothesis/)** | Propose hypotheses, link the evidence for and against them, and discuss |
| **[Timeline](/investigations/cases/timeline/)** | See everything that has happened in the case, in order |
...
1. **From an inquiry** — open a case straight from an
   [inquiry](/investigations/inquiry/); it's pre-linked and its current
   matches come in as starting evidence.
2. **From a confirmed duplicate** — in
   [Duplicate review](/duplicates/), turn a duplicate or
...
[Autopilot](/investigations/autopilot/) case agent can act on it on its
...
[Steering & Fine-Tuning](/investigations/autopilot/steering/) for how
...
recorded in the [timeline](/investigations/cases/timeline/). You can always
...
| Page | |
|---|---|
| [Hypothesis & Threads](/investigations/cases/hypothesis/) | Propose explanations and test them against evidence |
| [Timeline](/investigations/cases/timeline/) | The complete activity log of a case |
| [Graph](/investigations/cases/graph/) | The visual investigation tool |
