...
**investigation case file**. This page walks the path a piece of information
...
A **case** is the investigation case file. It holds the **evidence** you've
gathered, the discussion around it, and ultimately a written **conclusion**.
Cases can start from an inquiry, from a confirmed duplicate (see
[Connections & Duplicates](/how-it-works/duplicates-and-similarity/)), or
from scratch.
