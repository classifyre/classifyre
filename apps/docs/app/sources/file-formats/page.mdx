...
description: Every file type Classifyre can read — PDFs and Office documents, spreadsheets, CSV, Parquet and Arrow tables, images, audio, video, email, and archives — and which connected sources those files come from.
---
