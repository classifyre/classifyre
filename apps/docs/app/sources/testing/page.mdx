...
- **[Scans](/flow/)** — what a scan does step by step, and how repeat scans diff
  against the previous run.
- **[Investigations](/investigations/)** — how findings become inquiries and
  cases.
- **[Autopilot](/investigations/autopilot/)** — the AI agents that act on new
