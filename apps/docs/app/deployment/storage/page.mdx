...
description: Configuring external S3-compatible object storage for Classifyre runner logs.
---
...
Classifyre uses **S3-compatible object storage** to persist long-term runner execution logs. Files uploaded to a Sandbox source are stored in PostgreSQL and follow the normal source lifecycle.
