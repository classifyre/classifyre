...
graph LR
    ...
    Detectors --> Finding["Findings<br/>(with priority & confidence)"]
```
...
| **[Findings & Results](/detectors/findings/)**       | What a detector produces — every field of a finding, priority levels, confidence, and the status lifecycle. |
...
| **Object Detection**     | Image    | Locating objects, label-based priority              |
