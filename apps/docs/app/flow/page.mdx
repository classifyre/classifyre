...
[Detectors](/detectors/), and [Investigations](/investigations/).
...
- **[Investigations](/investigations/)** — the full picture of how findings
  become inquiries, duplicates, cases, and hypotheses.
- **[Inquiries](/investigations/inquiry/)** — standing questions that keep
  surfacing matching findings.
- **[Duplicate review](/duplicates/)** — duplicate and
  similarity detection across assets.
- **[Autopilot](/investigations/autopilot/)** — AI agents that act on new
