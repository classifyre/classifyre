"""Routing tests for FileEvaluationRunner.
...
from src.file_evaluation.runner import FileEvaluationRunner
...
def _runner_with(detector: _RecordingDetector) -> FileEvaluationRunner:
