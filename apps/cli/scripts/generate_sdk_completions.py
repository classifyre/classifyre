...
from src.augmentation import contract as augmentation_contract  # noqa: E402
from src.augmentation import sdk as augmentation_sdk  # noqa: E402
...
def build() -> dict[str, Any]:
    return {
        "$comment": (
            ...
            "apps/cli/src/notebook/sdk.py and apps/cli/src/augmentation/sdk.py. "
            "Do not edit by hand."
        ),
        "module": "classifyre",
        "globals": [
        ...
        "objects": {
            ...
            "augmentation": {
                "ctx": {
                    "type": "AugmentContext",
                    "members": _members(augmentation_sdk.AugmentContext),
                },
                "asset": {
                    "type": "AugmentedAsset",
        ...
        "contract": {
            ...
            "augmentation": {
                "required": list(augmentation_contract.REQUIRED_FUNCTIONS),
                "optional": list(augmentation_contract.OPTIONAL_FUNCTIONS),
            },
        },
    }
