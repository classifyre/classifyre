  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 grid auto-rows-[minmax(120px,auto)] grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-3.5 xl:grid-cols-12">
        ...
        <PanelCard className="flex flex-col justify-between overflow-hidden border-accent/30 bg-foreground dark:bg-background text-accent sm: sm:p-6 xl:col-span-3 xl:row-span-2">
