...
const ICON_PATHS: Record<string, string> = {
  ...
  image:
    "M5 3 L19 3 A2 2 0 0 1 21 5 L21 19 A2 2 0 0 1 19 21 L5 21 A2 2 0 0 1 3 19 L3 5 A2 2 0 0 1 5 3 Z M9 7 a2 2 0 1 1 0 4 a2 2 0 1 1 0 -4 m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21",
  messageSquare:
  ...
  table:
    "M12 3v18 M5 3 L19 3 A2 2 0 0 1 21 5 L21 19 A2 2 0 0 1 19 21 L5 21 A2 2 0 0 1 3 19 L3 5 A2 2 0 0 1 5 3 Z M3 9h18 M3 15h18",
  database:
    "M3 5 A9 3 0 1 1 21 5 A9 3 0 1 1 3 5 M3 5 V19 A9 3 0 0 0 21 19 V5 M3 12 A9 3 0 0 0 21 12",
  notebook:
    "M2 6h4 M2 10h4 M2 14h4 M2 18h4 M6 2 L18 2 A2 2 0 0 1 20 4 L20 20 A2 2 0 0 1 18 22 L6 22 A2 2 0 0 1 4 20 L4 4 A2 2 0 0 1 6 2 Z M16 2v20",
  workflow:
    "M5 3 L9 3 A2 2 0 0 1 11 5 L11 9 A2 2 0 0 1 9 11 L5 11 A2 2 0 0 1 3 9 L3 5 A2 2 0 0 1 5 3 Z M7 11v4a2 2 0 0 0 2 2h4 M15 13 L19 13 A2 2 0 0 1 21 15 L21 19 A2 2 0 0 1 19 21 L15 21 A2 2 0 0 1 13 19 L13 15 A2 2 0 0 1 15 13 Z",
  hash: "M4 9 L20 9 M4 15 L20 15 M10 3 L8 21 M16 3 L14 21",
  video:
    "m16 13 5.223 3.482a.5.5 0 0 0 .777-.416V7.87a.5.5 0 0 0-.752-.432L16 10.5 M4 6 L14 6 A2 2 0 0 1 16 8 L16 16 A2 2 0 0 1 14 18 L4 18 A2 2 0 0 1 2 16 L2 8 A2 2 0 0 1 4 6 Z",
  music:
    "M9 18V5l12-2v13M3 18a3 3 0 1 0 6 0a3 3 0 1 0-6 0M15 16a3 3 0 1 0 6 0a3 3 0 1 0-6 0",
  flaskConical:
    "M14 2v6a2 2 0 0 0 .245.96l5.51 10.08A2 2 0 0 1 18 22H6a2 2 0 0 1-1.755-2.96l5.51-10.08A2 2 0 0 0 10 8V2 M6.453 15h11.094 M8.5 2h7",
  folder:
    "M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z",
  gitBranch:
    "M15 6a9 9 0 0 0-9 9V3 M18 3 a3 3 0 1 1 0 6 a3 3 0 1 1 0 -6 M6 15 a3 3 0 1 1 0 6 a3 3 0 1 1 0 -6",
  circleAlert:
    "M12 2 a10 10 0 1 1 0 20 a10 10 0 1 1 0 -20 M12 8 L12 12 M12 16 L12.01 16",
...
export function drawAssetIcon(
  ...
  const key = assetIconKey[kind] ?? "file";
  if (!ICON_PATHS[key]) {
