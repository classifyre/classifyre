                        ...
                        <div className="flex items-center gap-2">
                            {demoMode && (
                                <Tooltip>
                                    <TooltipTrigger asChild>
                                        <div
                                            className="flex cursor-default items-center gap-1.5 rounded-[4px] border border-amber-600/40 bg-amber-50 px-2 py-1 text-[11px] font-semibold uppercase tracking-[0.08em] text-amber-700 dark:border-amber-500/30 dark:bg-amber-950/40 dark:text-amber-400">
